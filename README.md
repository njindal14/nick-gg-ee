...
2. Run `root -l PairEff.C`. This analyzes the output files of STAR simulation `FemtoDst` files (both MC and reconstructed events), and saves the plots locally in `simulation_plots.root`. 
